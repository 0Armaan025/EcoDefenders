...
controller.B.onEvent(ControllerButtonEvent.Pressed, function on_b_pressed() {
    ...
    if (info.score() >= 5) {
        ...
        game.showLongText("You don't have 5 points yet!", DialogLayout.Left)
    }
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.snake, function on_on_overlap(sprite4: Sprite, otherSprite: Sprite) {
    game.splash("Please don't hurt animals, save them! Let's develop India!")
    info.changeScoreBy(-15)
})
sprites.onOverlap(SpriteKind.snake, SpriteKind.Player, function on_on_overlap2(sprite5: Sprite, otherSprite2: Sprite) {
    
    if (check_var == 0) {
        check_var = 1
        sprite5.sayText("Please Save me! take me to shelter please!", 2000, false)
...
scene.onOverlapTile(SpriteKind.monkey, assets.tile`
        myTile6
    `, function on_overlap_tile4(sprite6: Sprite, location4: tiles.Location) {
    game.splash("Thanks for providing me a home :)", "-Your friend Monkey")
    info.changeScoreBy(10)
    sprites.destroy(sprite6)
})
sprites.onOverlap(SpriteKind.monkey, SpriteKind.Player, function on_on_overlap3(sprite7: Sprite, otherSprite3: Sprite) {
    
    if (check_var_1 == 0) {
        check_var_1 = 1
        sprite7.sayText("Please Save me! take me to shelter please!", 2000, false)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.trash, function on_on_overlap4(sprite8: Sprite, otherSprite4: Sprite) {
    music.play(music.melodyPlayable(music.baDing), music.PlaybackMode.UntilDone)
    info.changeScoreBy(1)
    sprites.destroy(otherSprite4, effects.spray, 500)
})
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Enemy, function on_on_overlap5(sprite9: Sprite, otherSprite5: Sprite) {
    my_enemy.sayText("Good Job! :)", 2000, true)
    my_enemy.sayText("Go, Save the Environment!", 2000, true)
    sprites.destroy(otherSprite5, effects.fire, 2000)
    info.changeScoreBy(10)
    music.play(music.melodyPlayable(music.baDing), music.PlaybackMode.UntilDone)
})
scene.onOverlapTile(SpriteKind.snake, assets.tile`
        myTile6
    `, function on_overlap_tile5(sprite10: Sprite, location5: tiles.Location) {
    game.splash("Thanks for providing me a home :)", "-Your friend Snake")
    info.changeScoreBy(10)
    sprites.destroy(sprite10)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function on_on_overlap6(sprite11: Sprite, otherSprite6: Sprite) {
...
my_enemy = sprites.create(img`
        ........................
            ...
            ........................
    `, SpriteKind.Enemy)
game.splash("Press A to start the game or interact", "You need to pick up trash, warrior! make the environment clean and contribute to Swach-Bharat Abhyan")
let net2 = sprites.create(img`
        f . . . . . . . . . . . 
            f f . . . . . . . . . . 
            . f f . . . . . . . . . 
            . . f f . . . f f f f . 
